 ...
 */
class CreatePkiWorkload extends WorkloadModuleBase {
    /**
    ...
    async initializeWorkloadModule(workerIndex, totalWorkers, roundIndex, roundArguments, sutAdapter, sutContext) {
        ...
        this.chaincodeID = args.chaincodeID ? args.chaincodeID : 'asset-enc';
        ...
        if (noSetup) {
            ...
            console.log('sutAdapter:'+JSON.stringify(this.sutAdapter)+'\n');
            console.log('sutContext:'+JSON.stringify(this.sutContext)+'\n');
            console.log('workerIndex:'+this.workerIndex+'\n');
            console.log('args:'+JSON.stringify(args)+'\n');
            await helper.addEncryptAssets(this.sutAdapter, this.sutContext, this.workerIndex, args);
